# LOCATION: services/job_service/job_service/models/global_models.py

"""
Job Service's read-only view of insynchire_global -- `tenants` (to
resolve/decrypt a connection string and list ACTIVE tenants) and
`global_users` (to check an authenticated caller's account_type, same
minimal-mirror pattern as user_profile_service/tenant_service). This
service never writes either table.
"""
