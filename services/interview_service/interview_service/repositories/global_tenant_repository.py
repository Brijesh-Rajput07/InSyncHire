# LOCATION: services/interview_service/interview_service/repositories/global_tenant_repository.py

"""Read-only repository for `tenants` (insynchire_global) -- Interview
